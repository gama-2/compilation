 ...
 * </p>
 * <ul>
 *   <li>{@link gama.gaml.compiler.gaml.S_Try#getCatch <em>Catch</em>}</li>
 * </ul>
 *
 * @see gama.gaml.compiler.gaml.GamlPackage#getS_Try()
 * @model
 * @generated
 */
public interface S_Try extends Statement
{
   ...
   * @see #setCatch(Block)
   * @see gama.gaml.compiler.gaml.GamlPackage#getS_Try_Catch()
  ...
  /**
   * Sets the value of the '{@link gama.gaml.compiler.gaml.S_Try#getCatch <em>Catch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
