 ...
 * </p>
 * <ul>
 *   <li>{@link gama.gaml.compiler.gaml.Array#getExprs <em>Exprs</em>}</li>
 * </ul>
 *
 * @see gama.gaml.compiler.gaml.GamlPackage#getArray()
 * @model
 * @generated
 */
public interface Array extends Expression
{
   ...
   * @see gama.gaml.compiler.gaml.GamlPackage#getArray_Exprs()
  ...
  /**
   * Sets the value of the '{@link gama.gaml.compiler.gaml.Array#getExprs <em>Exprs</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
