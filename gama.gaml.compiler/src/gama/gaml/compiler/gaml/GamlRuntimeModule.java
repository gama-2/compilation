...
import gama.gaml.compiler.gaml.linking.GamlLinkingErrorMessageProvider;
import gama.gaml.compiler.gaml.linking.GamlLinkingService;
import gama.gaml.compiler.gaml.naming.GamlNameConverter;
import gama.gaml.compiler.gaml.naming.GamlQualifiedNameProvider;
import gama.gaml.compiler.gaml.parsing.GamlSyntaxErrorMessageProvider;
import gama.gaml.compiler.gaml.resource.GamlEncodingProvider;
import gama.gaml.compiler.gaml.resource.GamlResource;
import gama.gaml.compiler.gaml.resource.GamlResourceDescriptionManager;
import gama.gaml.compiler.gaml.resource.GamlResourceDescriptionStrategy;
import gama.gaml.compiler.gaml.validation.ErrorToDiagnoticTranslator;
import gama.gaml.compiler.gaml.validation.GamlResourceValidator;
import gaml.core.expressions.IExpressionCompiler;

/**
 * Use this class to register components to be used at runtime / without the Equinox extension registry.
 */
public class GamlRuntimeModule extends gama.gaml.compiler.AbstractGamlRuntimeModule {
	...
	public void configure(final Binder binder) {
		...
		// .toInstance(new gama.gaml.compiler.scoping.BuiltinGlobalScopeProvider());
	...
	public Class<? extends org.eclipse.xtext.scoping.IGlobalScopeProvider> bindIGlobalScopeProvider() {
		// return null;
		return gama.gaml.compiler.gaml.scoping.BuiltinGlobalScopeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.formatting.IFormatter> bindIFormatter() {
		return gama.gaml.compiler.gaml.formatting.GamlFormatter.class;
	}
}
