/*******************************************************************************************************
 *
 * GamlResourceIndexer.java, in gama.gaml.compiler, is part of the source code of the GAMA modeling and simulation
 * platform (v.1.9.0).
 *
 ...
 *
 ********************************************************************************************************/
package gama.gaml.compiler.gaml.indexer;
...
import gama.gaml.compiler.gaml.Import;
...
import gama.gaml.compiler.gaml.resource.GamlResource.ImportedResources;
...
public class GamlResourceIndexer {
	...
	/**
	 * @see gama.gaml.compiler.indexer.IModelIndexer#directImportersOf(org.eclipse.emf.common.util.URI)
	 */
