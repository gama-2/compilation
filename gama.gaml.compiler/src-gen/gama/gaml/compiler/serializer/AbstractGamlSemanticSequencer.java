...
public abstract class AbstractGamlSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == GamlPackage.eINSTANCE)
			...
			case GamlPackage.PARAMETER:
				sequence_Parameter(context, (gama.gaml.compiler.gaml.Parameter) semanticObject); 
				return; 
	 ...
	 * </pre>
	 */
	protected void sequence_Parameter(ISerializationContext context, gama.gaml.compiler.gaml.Parameter semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
