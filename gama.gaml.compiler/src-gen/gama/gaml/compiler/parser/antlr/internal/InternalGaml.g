			...
			(
				...
				lv_expr_2_0=ruleExpression
				{
					...
					set(
						...
						"expr",
						lv_expr_2_0,
						"gama.gaml.compiler.Gaml.Expression");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_pragmas_0_0=rulePragma
				{
					...
					add(
						...
						"pragmas",
						lv_pragmas_0_0,
						"gama.gaml.compiler.Gaml.Pragma");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_imports_3_0=ruleImport
				{
					...
					add(
						...
						"imports",
						lv_imports_3_0,
						"gama.gaml.compiler.Gaml.Import");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_block_4_0=ruleModelBlock
				{
					...
					set(
						...
						"block",
						lv_block_4_0,
						"gama.gaml.compiler.Gaml.ModelBlock");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_statements_1_0=ruleS_Section
				{
					...
					add(
						...
						"statements",
						lv_statements_1_0,
						"gama.gaml.compiler.Gaml.S_Section");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				}
				{
					...
					setWithLastConsumed(
						...
						"importURI",
						lv_importURI_1_0,
						"gama.gaml.compiler.Gaml.STRING");
				}
			)
		)
		(
				...
				(
					...
					lv_name_3_0=ruleValid_ID
					{
						...
						set(
							...
							"name",
							lv_name_3_0,
							"gama.gaml.compiler.Gaml.Valid_ID");
						afterParserOrEnumRuleCall();
					}
				)
			)
					...
					(
						...
						lv_plugins_3_0=ruleExpressionList
						{
							...
							set(
								...
								"plugins",
								lv_plugins_3_0,
								"gama.gaml.compiler.Gaml.ExpressionList");
							afterParserOrEnumRuleCall();
						}
					)
				)?
		...
		(
			...
			lv_exp_0_0=ruleHeadlessExperiment
			{
				...
				set(
					...
					"exp",
					lv_exp_0_0,
					"gama.gaml.compiler.Gaml.HeadlessExperiment");
				afterParserOrEnumRuleCall();
			}
		)
	)
			...
			(
				...
				lv_key_0_0=rule_ExperimentKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._ExperimentKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=rule_SpeciesKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._SpeciesKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=rule_1Expr_Facets_BlockOrEnd_Key
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._1Expr_Facets_BlockOrEnd_Key");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_firstFacet_1_0=ruleFirstFacetKey
				{
					...
					set(
						...
						"firstFacet",
						lv_firstFacet_1_0,
						"gama.gaml.compiler.Gaml.FirstFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)?
			...
			(
				...
				lv_key_0_0=rule_DoKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._DoKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_expr_2_0=ruleAbstractRef
				{
					...
					set(
						...
						"expr",
						lv_expr_2_0,
						"gama.gaml.compiler.Gaml.AbstractRef");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=rule_ReflexKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._ReflexKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_tkey_0_0=ruleTypeRef
				{
					...
					set(
						...
						"tkey",
						lv_tkey_0_0,
						"gama.gaml.compiler.Gaml.TypeRef");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_args_4_0=ruleActionArguments
					{
						...
						set(
							...
							"args",
							lv_args_4_0,
							"gama.gaml.compiler.Gaml.ActionArguments");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_1_0=rule_VarOrConstKey
				{
					...
					set(
						...
						"key",
						lv_key_1_0,
						"gama.gaml.compiler.Gaml._VarOrConstKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_key_1_0=rule_AssignmentKey
					{
						...
						set(
							...
							"key",
							lv_key_1_0,
							"gama.gaml.compiler.Gaml._AssignmentKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_0_0=rule_EquationsKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._EquationsKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
						...
						(
							...
							lv_equations_4_0=ruleS_Equation
							{
								...
								add(
									...
									"equations",
									lv_equations_4_0,
									"gama.gaml.compiler.Gaml.S_Equation");
								afterParserOrEnumRuleCall();
							}
						)
					)
				...
				(
					...
					lv_expr_0_1=ruleFunction
					{
						...
						set(
							...
							"expr",
							lv_expr_0_1,
							"gama.gaml.compiler.Gaml.Function");
						afterParserOrEnumRuleCall();
					}
					    |
					{
					...
					lv_expr_0_2=ruleVariableRef
					{
						...
						set(
							...
							"expr",
							lv_expr_0_2,
							"gama.gaml.compiler.Gaml.VariableRef");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_0_0=rule_SolveKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._SolveKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_expr_2_0=ruleEquationRef
				{
					...
					set(
						...
						"expr",
						lv_expr_2_0,
						"gama.gaml.compiler.Gaml.EquationRef");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_block_4_0=ruledisplayBlock
				{
					...
					set(
						...
						"block",
						lv_block_4_0,
						"gama.gaml.compiler.Gaml.displayBlock");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_statements_2_0=ruledisplayStatement
				{
					...
					add(
						...
						"statements",
						lv_statements_2_0,
						"gama.gaml.compiler.Gaml.displayStatement");
					afterParserOrEnumRuleCall();
				}
			)
		)*
			...
			(
				...
				lv_key_0_0=rule_ImageLayerKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml._ImageLayerKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_args_0_0=ruleArgumentDefinition
				{
					...
					add(
						...
						"args",
						lv_args_0_0,
						"gama.gaml.compiler.Gaml.ArgumentDefinition");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_key_0_0=ruleClassicFacetKey
					{
						...
						set(
							...
							"key",
							lv_key_0_0,
							"gama.gaml.compiler.Gaml.ClassicFacetKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_key_2_0=ruleSpecialFacetKey
					{
						...
						set(
							...
							"key",
							lv_key_2_0,
							"gama.gaml.compiler.Gaml.SpecialFacetKey");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_0_0=ruleDefinitionFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml.DefinitionFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=ruleTypeFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml.TypeFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
			...
			(
				...
				lv_key_0_0=ruleActionFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml.ActionFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_expr_1_0=ruleActionRef
					{
						...
						set(
							...
							"expr",
							lv_expr_1_0,
							"gama.gaml.compiler.Gaml.ActionRef");
						afterParserOrEnumRuleCall();
					}
				)
			)
			...
			(
				...
				lv_key_0_0=ruleVarFacetKey
				{
					...
					set(
						...
						"key",
						lv_key_0_0,
						"gama.gaml.compiler.Gaml.VarFacetKey");
					afterParserOrEnumRuleCall();
				}
			)
		)
				...
				(
					...
					lv_statements_2_0=ruleStatement
					{
						...
						add(
							...
							"statements",
							lv_statements_2_0,
							"gama.gaml.compiler.Gaml.Statement");
						afterParserOrEnumRuleCall();
					}
				)
			)*
				...
				(
					...
					lv_right_3_0=ruleAddition
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"gama.gaml.compiler.Gaml.Addition");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleMultiplication
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"gama.gaml.compiler.Gaml.Multiplication");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleExponentiation
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"gama.gaml.compiler.Gaml.Exponentiation");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleBinary
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"gama.gaml.compiler.Gaml.Binary");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					lv_right_3_0=ruleUnitRef
					{
						...
						set(
							...
							"right",
							lv_right_3_0,
							"gama.gaml.compiler.Gaml.UnitRef");
						afterParserOrEnumRuleCall();
					}
				)
			)
							...
							(
								...
								lv_right_6_2=ruleStringLiteral
								{
									...
									set(
										...
										"right",
										lv_right_6_2,
										"gama.gaml.compiler.Gaml.StringLiteral");
									afterParserOrEnumRuleCall();
								}
							)
						)
			...
			(
				...
				lv_type_2_0=ruleTypeInfo
				{
					...
					set(
						...
						"type",
						lv_type_2_0,
						"gama.gaml.compiler.Gaml.TypeInfo");
					afterParserOrEnumRuleCall();
				}
			)
		)?
				...
				(
					...
					lv_exprs_3_0=ruleParameter
					{
						...
						add(
							...
							"exprs",
							lv_exprs_3_0,
							"gama.gaml.compiler.Gaml.Parameter");
						afterParserOrEnumRuleCall();
					}
				)
			)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"op",
							lv_op_2_0,
							"gama.gaml.compiler.Gaml.INTEGER");
					}
				)
			)
		)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"op",
							lv_op_4_0,
							"gama.gaml.compiler.Gaml.DOUBLE");
					}
				)
			)
		)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"op",
							lv_op_6_0,
							"gama.gaml.compiler.Gaml.BOOLEAN");
					}
				)
			)
		)
				...
				(
					...
					}
					{
						...
						setWithLastConsumed(
							...
							"op",
							lv_op_8_0,
							"gama.gaml.compiler.Gaml.KEYWORD");
					}
				)
			)
		)
